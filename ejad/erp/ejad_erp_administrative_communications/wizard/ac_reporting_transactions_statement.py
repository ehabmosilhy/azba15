...
class ACReportingTransactionsStatement(models.TransientModel):
    _name = 'wiz.ac.transactions.report'
    _description = 'wiz ac transactions report'
    ...
    def export_xls(self):
        ...
        datas['model'] = 'ac.operation'
        datas['form'] = self.read()[0]
        for field in datas['form'].keys():
            if isinstance(datas['form'][field], tuple):
                datas['form'][field] = datas['form'][field][0]

        return self.env.ref('ejad_erp_administrative_communications.ac_reporting_transcaction_excel_sheet').report_action(self, data=datas)