odoo.define('ehab_backend_theme.ListController', function(require) {
    "use strict";
    ...
    var CustomizeList = Dialog.extend({
        ...
        _onChangeView: function(ev) {
            ...
            this.$('.o_density_image img').attr('src', '/ehab_backend_theme/static/src/img/' + this.default_density + '.png')
        },
    ...
    ListController.include({
        ...
        willStart: function() {
            ...
            const acl = this.getSession().user_has_group('ehab_backend_theme.group_display_density').then(hasGroup => {
